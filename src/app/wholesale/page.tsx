...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://rswriting.in/wholesale',
  },
  openGraph: {
    ...
    url: 'https://rswriting.in/wholesale',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'B2B Wholesale',
        item: 'https://rswriting.in/wholesale',
      },
    ],
  };
    ...
    <div id="main-wrapper" className="overflow-x-hidden min-h-screen relative" style={{ background: '#FDFBF7', color: '#1B2A2A' }}>
      ...
      <nav className="sticky top-0 w-full z-50 py-4 bg-[#FDFBF7]/90 backdrop-blur-md border-b border-[#E5DFD5]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          >
            <FaWhatsapp size={15} style={{ color: '#25D366' }} /> Request Quote
          </a>
        </div>
      </nav>
      ...
      <main className="py-12 px-6 md:px-12 max-w-6xl mx-auto">
        ...
        <div className="bg-[#102E29] text-[#FDFBF7] p-8 md:p-12 rounded-3xl text-center">
          <h2 className="font-serif text-3xl font-normal">Ready to place a wholesale order?</h2>
