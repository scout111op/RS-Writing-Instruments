...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'custom laser engraving fountain pen',
    'laser engraved nibs India',
    'custom engraved pen clips',
    'personalized fountain pen nibs',
    'custom nib artwork engraving',
    'bespoke pen engraving RS Writing',
  ],
...
export default function RootLayout({
  ...
  const organizationJsonLd = {
    ...
    knowsAbout: [
      ...
      'Custom Laser Engraving on Nibs',
      'Bespoke Pen Personalization',
      'Laser Etched Clips & Barrels',
    ],
    sameAs: [
