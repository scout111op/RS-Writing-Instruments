...
export const metadata: Metadata = {
  ...
  title: 'Bock #6 Type 250 series Fountain Pen Nibs | Precision Replacement Nibs',
  description:
    'Triple-inspected Bock #6 Type 250 series fountain pen nibs in Stealth Black PVD, Premium Golden, and Rose Gold. Dual-view front and back inspection. Select EEF to Double Broad point size.',
  keywords: [
    ...
    'ebonite feed bock nib',
    'black bock nib',
    'gold bock nib',
    'rose gold bock nib',
    'EEF fountain pen nib',
  ],
  alternates: {
  ...
  openGraph: {
    ...
    description: 'Precision Bock #6 Type 250 series replacement nibs with dual-view front and reverse inspection in 3 luxury finishes.',
  ...
  twitter: {
    ...
    title: 'Bock #6 Type 250 series Fountain Pen Nibs | RS Writing Instruments',
    description: 'Triple-inspected Bock #6 Type 250 series replacement nibs with interactive dual-view inspection.',
