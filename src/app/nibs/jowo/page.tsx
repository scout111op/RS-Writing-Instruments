...
export const metadata: Metadata = {
  ...
  title: 'Jowo Compatible Nibs #6 Type 250 | Precision German Replacement Nibs',
  description:
    'Shop precision German-profile Jowo compatible nibs (#6 Type 250 series) in Tactile Black, Premium Golden, and Rose Gold. Available in EEF to Double Broad point sizes.',
  keywords: [
    ...
    'Jowo nib unit',
    'Jowo #6 nibs',
    'Jowo collar nib replacement',
    'ebonite feed jowo nib pairing',
    'black jowo nib',
    'gold jowo nib',
    'rose gold jowo nib',
    'Jowo EEF nib',
  ...
  openGraph: {
    title: 'Jowo Compatible Nibs #6 Type 250 | RS Writing Instruments',
    description: 'Precision Jowo compatible replacement fountain pen nibs in 3 luxury finishes across 6 tip grades.',
    url: 'https://www.rswriting.in/nibs/jowo',
    siteName: 'RS Writing Instruments',
    images: [{ url: '/nibs/jowo-gold.webp', width: 1200, height: 900, alt: 'Jowo Compatible Nibs #6 Type 250 Series' }],
    locale: 'en_IN',
    type: 'website',
  },
  twitter: {
