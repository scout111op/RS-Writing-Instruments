...
export const metadata: Metadata = {
  ...
  title: 'Precision Fountain Pen Nibs | Bock & Jowo Compatible #6 Replacement Nibs',
  description:
    'Shop standalone Bock compatible and Jowo compatible fountain pen replacement nibs (#6 Type 250 series) in Stealth Black PVD, Premium Golden, and Rose Gold. Choice of EEF, EF, Fine, Medium, Broad, and Double Broad points.',
  keywords: [
    'Bock compatible nibs',
    'Jowo compatible nibs',
    'Bock compatable nibs',
    'Jowo compatable nibs',
    'Bock #6 Type 250 series',
    'Jowo #6 Type 250 series',
    'fountain pen replacement nibs',
    'Bock replacement nib',
    'Jowo replacement nib',
    'Bock compatible nib India',
    'Jowo compatible nib India',
    '#6 fountain pen nibs',
    'Bock 250 replacement nib',
    'Jowo #6 replacement nib',
    'rose gold fountain pen nib',
    'black fountain pen nib',
    'gold fountain pen nib',
    'ebonite feed nib pairing',
    'fountain pen nib points EEF EF Medium Broad Double Broad',
    'German nibs India',
    'custom pen parts nibs',
  ],
  alternates: {
    canonical: 'https://www.rswriting.in/nibs',
  },
  openGraph: {
    title: 'Precision Fountain Pen Nibs | Bock & Jowo Compatible Nibs | RS Writing Instruments',
    description:
      'Standalone #6 fountain pen nibs engineered for Bock compatible and Jowo compatible Type 250 series geometries. Dual-view inspection, 3 luxury finishes, and 6 tip grades.',
  ...
  twitter: {
    ...
    title: 'Precision Fountain Pen Nibs | Bock & Jowo Compatible Nibs',
    description: 'Precision German-profile Bock and Jowo compatible replacement fountain pen nibs in Stealth Black, Premium Golden, and Rose Gold.',
