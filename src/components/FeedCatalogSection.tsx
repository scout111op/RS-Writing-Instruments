        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 items-stretch">
          {filteredFeeds.map((feed) => {
            ...
            return (
              ...
              >
                {/* Fixed Aspect Ratio Image Frame (Prevents Layout Shifts & Overflow) */}
                <div 
                  className="product-image-frame w-full aspect-[4/3] mb-4 rounded-xl flex items-center justify-center relative"
